...
function Upsert(prdId, quantity) {
    ...
    if (typeof iFoundTheItemUsingThePrdId !== "undefined") {
        ...
        addToCart(prdId, qunaty);

    } else //update

    {
        updateTheCart(prdId, qunaty);
...
function updateTheCart(prdId, qunaty) {
